...
Both services are implemented using [Micronaut](https://micronaut.io), JPA and the https://github.com/eventuate-tram/eventuate-tram-sagas[Eventuate Tram Saga framework]
